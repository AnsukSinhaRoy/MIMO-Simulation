...
from equalizers import zero_forcing_equalizer, mmse_equalizer
...
def run_simulation():
    ...
    for idx, snr in enumerate(SNR_linear):
        ...
        print(f"SNR: {SNR_dB[idx]} dB -> BER_ZF: {BER_ZF[idx]:.6f}, BER_MMSE: {BER_MMSE[idx]:.6f}")

    return SNR_dB, BER_ZF, BER_MMSE
